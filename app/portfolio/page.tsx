      ...
      <main className="min-h-screen bg-[#FAFAF8] pt-24 md:pt-32">
        ...
        <section className="px-4 sm:px-6 py-12 md:py-20 text-center">
          ...
          <p className="mx-auto mt-2 max-w-7xl px-2 text-base sm:text-lg leading-relaxed text-[#6E6E6E]">
            Explore our curated collection of weddings,
            bridal portraits and cinematic moments captured
            with emotions, elegance and timeless beauty.
          </p>
    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center">
          <p className="text-sm uppercase tracking-[4px] text-[#B79A5F]">
            Loading Portfolio...
          </p>
        </div>
      }
